...
Everything works fully offline: all 940 entries and 649 plant photos are bundled into the app itself, so it needs zero internet connection once installed.

## What's in the app

- **856 confirmed entries** — who used a remedy, what it was for, how it was made, and the real story behind it
...
- Real safety cautions on 439 entries where one was warranted — not invented, only added where a real risk is documented
...
- `src/data/entries.json` — all 940 entries
- `assets/plant-images/` — all 649 photos, bundled into the app
