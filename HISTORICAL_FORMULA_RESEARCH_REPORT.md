...
| --- | --- | --- |
| Barley Water | *The New Royal Cook Book* (1920), p. 45 | Exact American period formula |
| Arrowroot Starch | May Henry and Edith B. Cohen, *The Economical Jewish Cook*, 3rd ed. (1897), p. 67 | Exact period method; not a source for the entry’s American cultural attribution |
| Rice Water | Mary A. Boland, *A Handbook of Invalid Cooking* (1893), p. 102 | Exact American period formula; not a source for the Gullah/Lowcountry attribution or effectiveness |
...
5. Current authoritative sources support the material food-safety, interaction, pregnancy, allergy, or hydration warnings.
...
- Optional or “to taste” ingredients are either omitted from the measured list or explicitly identified as unmeasured; no quantities were invented.
...
- [Mary A. Boland, *A Handbook of Invalid Cooking* (1893), Beef Broth, pp. 78–79](https://www.gutenberg.org/files/54568/54568-h/54568-h.htm#Page_78)
...
- [NIDDK: Treatment of Diarrhea](https://www.niddk.nih.gov/health-information/digestive-diseases/diarrhea/treatment)
...
- `npm run audit:build` regenerates the one-row-per-entry content ledger.
- `npm run validate:content` checks every entry disposition, image mapping, JPEG, photo credit, USDA range, and formula assignment.
- `npm run validate:formulas` checks formula-to-entry links, duplicate records, measured amounts, source URLs, safety-source coverage, caution exclusions, and blocked ingredients.
